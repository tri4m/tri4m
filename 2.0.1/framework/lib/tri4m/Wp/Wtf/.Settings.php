			...
			isset($__STATIC_fnF) ?: $__STATIC_fnF = function(__type_Settings $__Setup, __type_Section $__Section, __type_Field $__Field)
			{
				...
				(
					...
					[
						'type'		=> $__Field->type,
						'desc'		=> $__Field->desc,
						'id'		=> String::insert('{:setupId}_{:sectionId}_{:fieldId}', ['setupId' => $__Setup->id, 'sectionId' => $__Section->id, 'fieldId' => $__Field->id]),
						'label_for'	=> String::insert('{:setupId}_{:sectionId}_{:fieldId}', ['setupId' => $__Setup->id, 'sectionId' => $__Section->id, 'fieldId' => $__Field->id]),
