<?PHP
	...
	TRAIT __trait_Log
	{
		...
		static function enabled($__start)
		{
			static::$__logging[get_called_class()]	= (bool) $__start;
		}
		...
		static function add()
		{
			FALSE === static::$__logging[get_called_class()]
		...
		static function show()
		{
			...
			|| [] === static::$__log[get_called_class()]
				? NULL
				: implode(PHP_EOL, static::$__log[get_called_class()]);
		}
